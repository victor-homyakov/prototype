/*global $, $$, $A, $H, $w, Element, Node, Prototype, Test */
...
new Test.Unit.Runner({
  ...
  testDollarFunction: function() {
    ...
    this.assertRespondsTo('descendantOf', elt);
  },
  ...
  testNewElement: function() {
    ...
    XHTML_TAGS.each(function(tag, index) {
      ...
      try {
        ...
        details = "this.assert(element === document.body.lastChild)";
        this.assert(element === document.body.lastChild);
        //details = "this.assertEqual(element, document.body.lastChild)";
        //this.assertEqual(element, document.body.lastChild); // raises exception in IE8
        details = "element.id";
        this.assertEqual(id, element.id);
      } catch (ex) {
        this.fail("Exception on '" + details + "' for id " + id + ", element " + element);
        throw ex;
      }
    }, this);
    ...
    var elWithClassName = new Element('div', { 'className': 'firstClassName' });
